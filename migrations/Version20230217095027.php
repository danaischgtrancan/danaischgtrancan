 ...
 */
final class Version20230217095027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, birthday DATE NOT NULL, address VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, gender TINYINT(1) NOT NULL, fullname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (cart_id INT AUTO_INCREMENT NOT NULL, pid VARCHAR(10) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, username VARCHAR(10) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, pcount INT NOT NULL, INDEX username (username), INDEX pid (pid), PRIMARY KEY(cart_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
