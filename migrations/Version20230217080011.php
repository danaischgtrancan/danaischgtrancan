 ...
 */
final class Version20230217080011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD id INT AUTO_INCREMENT NOT NULL, ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD phone_number INT NOT NULL, ADD full_name VARCHAR(255) NOT NULL, DROP username, DROP firstName, DROP lastName, DROP telephone, DROP role, CHANGE password password VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE birthday day_of_birth DATE NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(10) NOT NULL, ADD firstName VARCHAR(15) NOT NULL, ADD lastName VARCHAR(20) NOT NULL, ADD telephone VARCHAR(12) NOT NULL, ADD role TINYINT(1) NOT NULL, DROP id, DROP roles, DROP phone_number, DROP full_name, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(50) NOT NULL, CHANGE day_of_birth birthday DATE NOT NULL');
